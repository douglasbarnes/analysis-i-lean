...
def sourceInventory : List SourceItem := [
  ...
  ⟨566, "proposition", "", "conservative_energy_derivative_zero"⟩,
  ⟨590, "definition", "Central force", "IsCentralPotential"⟩,
  ⟨595, "proposition", "", "radial_unit_norm"⟩,
  ⟨615, "proposition", "", "central_force_radial"⟩,
  ⟨631, "definition", "Angular momentum", "angularMomentum"⟩,
  ⟨638, "proposition", "", "angularMomentum_derivative_zero"⟩,
  ⟨649, "definition", "Torque", "torque"⟩,
  ⟨661, "law", "Newton's law of gravitation", "NewtonGravitationLaw"⟩,
  ⟨676, "definition", "Gravitaional potential and field", "gravitationalPotential"⟩,
  ⟨698, "proposition", "", "spherical_exterior_potential"⟩,
  ⟨752, "law", "Lorentz force law", "LorentzForceLaw"⟩,
  ⟨762, "definition", "Electrostatic potential", "IsElectrostaticPotential"⟩,
  ⟨769, "proposition", "", "static_electromagnetic_energy_derivative_zero"⟩,
  ⟨868, "law", "Columb's law", "CoulombLaw"⟩,
  ⟨884, "definition", "Electric constant", "ElectricConstant"⟩,
  ⟨1039, "proposition", "", "polar_unit_vector_derivatives"⟩,
  ...
  ⟨1248, "notation", "", "reciprocalRadius"⟩,
  ⟨1268, "proposition", "Binet's equation", "binet_equation"⟩,
  ⟨1299, "proposition", "", "keplerOrbit_satisfies_reciprocal"⟩,
  ...
  ⟨1540, "proposition", "", "rotating_derivative_formula"⟩,
  ⟨1562, "proposition", "", "rotating_frame_equation"⟩,
  ⟨1568, "definition", "Fictious forces", "fictitiousForces"⟩,
  ...
  ⟨1951, "proposition", "Rocket equation", "rocket_equation"⟩,
  ...
  ⟨2048, "definition", "", "rigidBodyAngularMomentum"⟩,
  ...
  ⟨3013, "proposition", "", "lorentz_interval_invariant"⟩,
  ...
  ⟨3221, "definition", "Position 4-vector and 4-velocty", "positionFourVector"⟩,
