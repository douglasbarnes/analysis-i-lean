...
/-!
# Finite-dimensional distributions of real Brownian motion

Local backport of the canonical Gaussian projective family used by the Brownian-motion API.
-/
...
/-- Covariance matrix of Brownian finite-dimensional distributions. -/
...
/-- Centered Gaussian finite-dimensional Brownian law over a finite time set. -/
...
/-- One-time Brownian marginal is centered Gaussian of variance `s`. -/
...
/-- Brownian increment marginal is centered Gaussian of variance equal to elapsed distance. -/
