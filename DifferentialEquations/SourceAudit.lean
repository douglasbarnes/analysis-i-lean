...
def inventory : List Entry := [
  ...
  ⟨83, .notation, "Prime derivative notation", "deriv", .notation⟩,
  ...
  ⟨242, .notation, "Indefinite integral notation", "antiderivative (not canonical notation)", .notation⟩,
  ...
  ⟨330, .notation, "Partial derivative subscripts", "fderiv", .notation⟩,
