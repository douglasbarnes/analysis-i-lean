...
and analytic calculus, finite covering/packing bounds, a proved finite-class
...
continuous-mapping and Slutsky theorems, and Brownian-bridge covariance/variance
identities.  The product-geometry, entropy-method, empirical-entropy, canonical
